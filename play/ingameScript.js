...
var seeds = [
	...
	["Common Seeds", [
		...
		["1.1.1.3", "Corn", "Time for a BBQ, with some corn-on-the-COB!", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.4", "Potato", "P-O-T-A-T-O that spells POTATO!", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.5", "Zucchini", "A thick cucumber-looking vegetable, that can make some tasty muffins, look it up.", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.6", "Cabbage (Green)", "A filling vegetable, that could probably only last me a day", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.7", "Cabbage (Purple)", "I always have some hand on taco night!", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.8", "Celery", "They say that it takes more calories to digest than gained by eating it.... ", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.9", "Cucumber", "Try some with chilly pepper powder, it's very good.", 0, 0, 3, 0.00, 0, false, false, "Common", 0, 0],
		["1.1.1.10", "Mint", "A great and classic herb to grow, now don't let it get out of control.", 0, 0, 3, 0.00, 0, false, false, "Common", 1, 0],
		["1.1.1.11", "Fennel", "This reminds me of California trails, covered in dill fennel.", 0, 0, 3, 0.00, 0, false, false, "Common", 1, 0],
		["1.1.1.12", "Basil", "Now it's time for you to make some pesto!", 0, 0, 3, 0.00, 0, false, false, "Common", 1, 0],
		["1.1.1.13", "Carrot (Red)", "I never knew these were real until looking up different carrot varieties for this game.", 0, 0, 3, 0.00, 0, false, false, "Common", 2, 0],
		["1.1.1.14", "Carrot (Orange)", "Classic, never gets old..... until it does.", 0, 0, 3, 0.00, 0, false, false, "Common", 2, 0],
		["1.1.1.15", "Carrot (Purple)", "The coolest variety of a carrot ever!", 0, 0, 3, 0.00, 0, false, false, "Common", 2, 0],
		["1.1.1.16", "Carrot (White)", "This is a thing? What does it taste like, that's for you to find out!", 0, 0, 3, 0.00, 0, false, false, "Common", 2, 0],
		["1.1.1.17", "Radish", "If you pickle it, it tastes great with sushi.", 0, 0, 3, 0.00, 0, false, false, "Common", 2, 0],
		["1.1.1.18", "Oats", "A healthy replacement to cereal, but I doubt any of us care.", 0, 0, 3, 0.00, 0, false, false, "Common", 3, 0],
		["1.1.1.19", "Rice", "It might not look nice when harvested, but rest assured, when cooked or steamed right, you will get great food.", 0, 0, 3, 0.00, 0, false, false, "Common", 3, 0],
		...
		["1.1.1.21", "Rose", "Praised for the looks and smell, but......  I don't smell anything, but they look beautiful", 0, 0, 3, 0.00, 0, false, false, "Common", 6, 0],
		["1.1.1.22", "Sunflower", "A pretty flower to start your garden growing journey.", 0, 0, 3, 0.00, 0, false, false, "Common", 6, 0]
	]],
	["Uncommon Seeds", [
		["1.1.2.1", "Bell Pepper (Red)", "Not all spicy, and it's a good  food to add color to your diet.", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.2", "Bell Pepper (Orange)", "A bell pepper is the fruit of a flowering plant, a cultivar of Capsicum annuum. While used as a vegetable in culinary.........", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.3", "Bell Pepper (Yellow)", "The rainbow of bell pepper goes on, yellow is the best tasting one. (In my opinion)", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.4", "Bell Pepper (Green)", "The 'hardest' of the bell peppers having a slightly thicker crunch.", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.5", "Bell Pepper (Purple)", "Great color on a dress, great color on some food! ", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.6", "Tremella Mesenterica Mushroom", "The classic 'witch' mushroom! WITCH! WITCH! WITCH!", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.7", "Rhubarb", "My mom makes great strawberry and rhubarb pie..... hint hint", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.8", "Lettuce", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.9", "Oyster Mushroom", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 0, 0],
		["1.1.2.10", "Thime", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 1, 0],
		["1.1.2.11", "Lavender", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 1, 0],
		["1.1.2.12", "Nutmeg", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 1, 0],
		["1.1.2.13", "Parsley", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 1, 0],
		["1.1.2.14", "Green Bean", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 1, 0],
		["1.1.2.15", "Onion (White)", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 2, 0],
		["1.1.2.16", "Onion (Purple)", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 2, 0],
		["1.1.2.17", "Banana", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 5, 0],
		["1.1.2.18", "Ivy", "Seed Description", 0, 0, 3, 0.00, 0, false, false, "Uncommon", 6, 0]
	]],
	["Rare Seeds", [
	...
	["Mythic Seeds", [
		["1.1.5.1", "King Coconut", "Firey red, pationate and powerful are the perfect words to describe the King Coconut (or me, you could say both). Primarily found in Sri Lanka, a beautiful place in South Asia, they make a name for themselves with their refreshing taste.", 0, 0, 3, 0.00, 0, false, false, "Mythic", 4, 0],
		["1.1.5.2", "Pomegranate", "My personal favorite fruit to eat, my personal least favorite to clean up. Pomegranates have tons of seeds and in various cultures, they often represent fertility, abundance, and prosperity.", 0, 0, 3, 0.00, 0, false, false, "Mythic", 4, 0],
		["1.1.5.3", "Bamboo", "Found primarily in warm and moist tropical and temperate climates bamboo is a strong, green, tall, delicious (to pandas) and majestic plant. It covers a total of 0.38% of the earth. ", 0, 0, 3, 0.00, 0, false, false, "Mythic", 5, 0],
		["1.1.5.4", "Moonflower", "Also known as the tropical white morning-glory, grown, this stunning flower grows annually, depending on the region.", 0, 0, 3, 0.00, 0, false, false, "Mythic", 5, 0],
		["1.1.5.5", "Shenzhen Nongke Orchid", "Coming in hot with world fame, and an auction price higher than my salary for ten years, this orchid is renowned for its beautiful shape, stunning colors, and the fact that it only blooms once every few years.", 0, 0, 3, 0.00, 0, false, false, "Mythic", 6, 0],
		["1.1.5.6", "Black Bat Flower", "This flower bears a stunning resemblance to a bat. The black bat flower is considered poisonous, to pets, and humans, and everything, so, don't eat it.", 0, 0, 3, 0.00, 0, false, false, "Mythic", 6, 0]
	]],
	["Alchemy Seeds", [
